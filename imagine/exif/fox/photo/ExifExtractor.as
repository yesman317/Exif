package nt.imagine.exif.fox.photo
{
	import flash.utils.ByteArray;
	
	import nt.imagine.exif.fox.photo.exif.InternalExif;
	import nt.imagine.exif.fox.photo.exif.ifd.IFD;
	import nt.imagine.exif.fox.photo.jpeg.Exif;
	import nt.imagine.exif.fox.photo.jpeg.JpegTag;
	import nt.imagine.exif.fox.photo.jpeg.SOF0;
	...
	public class ExifExtractor
	{
		...
		public function readExif(image:ByteArray):Exif
		{
			...
			if (exifData)
			{
				...
				{
					trace("readExif new Exif1111");
					exif=new Exif();
				}
			}
			else
			{
				trace("readExif new Exif 222");
				exif=new Exif();
			}
